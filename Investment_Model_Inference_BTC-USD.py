...
X = model_data2[[
'PS_ratio_perc_isotonic_dec','unrate_1yrchg_perc_isotonic_inc','real_estate_1yrchg_perc_isotonic_dec',
'3mth/6mth_mvg_avg_perc_isotonic_dec'
]]
...
X = model_data2[[
'unrate_perc_isotonic_inc','PS_ratio_perc_isotonic_dec','tenyr_minus_threemth_perc_isotonic_dec',
'1mth/3mth_mvg_avg_perc_isotonic_inc','cpi_1yrchg_perc_isotonic_dec','M1_1yrchg_perc_isotonic_dec',
'tenyr_minus_threemth_perc_isotonic_inc'
]]
X.fillna(method='ffill', inplace=True)
