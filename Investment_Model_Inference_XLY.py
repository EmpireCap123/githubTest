...
model_data['24mth_hist'] = round(model_data[symbol]/model_data[symbol].shift(periods=520)-1,2)
...
model_data = model_data.dropna(subset=['12mth/24mth_mvg_avg'])
model_data
...
'1day_hist', '1wk_hist', '1mth_hist', '3mth_hist', '6mth_hist', '9mth_hist', '12mth_hist', '24mth_hist',
'12mth/24mth_mvg_avg', '6mth/12mth_mvg_avg', '3mth/6mth_mvg_avg', '1mth/3mth_mvg_avg', '1wk/1mth_mvg_avg', '1day/1wk_mvg_avg',
timeframe
]].iloc[261:]
...
'1day_hist_perc', '1wk_hist_perc', '1mth_hist_perc', '3mth_hist_perc', '6mth_hist_perc', '9mth_hist_perc', '12mth_hist_perc', '24mth_hist_perc',
'12mth/24mth_mvg_avg_perc', '6mth/12mth_mvg_avg_perc', '3mth/6mth_mvg_avg_perc', '1mth/3mth_mvg_avg_perc', '1wk/1mth_mvg_avg_perc', '1day/1wk_mvg_avg_perc',
]
...
X = model_data2[[
'unrate_perc_isotonic_inc','VIX_perc_isotonic_inc',
'12mth/24mth_mvg_avg_perc_isotonic_dec','3mth_hist_perc_isotonic_dec',
'ShillerPE_ratio_perc_isotonic_inc', '10y_yield_minus_cpi_perc_isotonic_dec',
'EY_minus_cpi_perc_isotonic_inc'
]]
...
X = model_data2[[
'EY_minus_10y_yield_perc_isotonic_inc','oil_1yrchg_perc_isotonic_dec',
'ShillerPE_ratio_perc_isotonic_inc'
]]
...
result.to_excel('C:\\Users\\Jeremiah\\OneDrive\\Desktop\\J\\Investing\\Analysis v2\\XLY_prediction.xlsx')
