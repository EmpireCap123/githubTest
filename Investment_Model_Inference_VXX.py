...
X = model_data2[[
'tenyr_minus_threemth_perc_isotonic_dec','real_estate_1yrchg_perc_isotonic_dec','VIX_perc_isotonic_dec',
'6mth/12mth_mvg_avg_perc_isotonic_dec','ShillerPE_ratio_perc_isotonic_inc','6mth/12mth_mvg_avg_perc_isotonic_dec',
'GLD_1yrchg_perc_isotonic_inc','1wk/1mth_mvg_avg_perc_isotonic_inc', '1day/1wk_mvg_avg_perc_isotonic_inc',
'cpi_1yrchg_perc_isotonic_dec'
]]
...
X = model_data2[[
'gdp_1yrchg_perc_isotonic_inc','GLD_1yrchg_perc_isotonic_inc','oil_1yrchg_perc_isotonic_dec',
'unrate_1yrchg_perc_isotonic_inc','GLD_1yrchg_perc_isotonic_dec'
]]
X = X.fillna(1)
print(X)
...
result = pd.concat([model_data2[timeframe].reset_index().tail(1), prediction.tail(1)], axis=1)
result.columns = ['date',timeframe,'prediction']
result['timeframe'] = timeframe
result = result[['date','timeframe','prediction']].tail(1)
...
result.to_excel('C:\\Users\\Jeremiah\\OneDrive\\Desktop\\J\\Investing\\Analysis v2\\' + symbol + '_prediction.xlsx')
